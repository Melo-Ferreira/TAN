...
#A mulher relata ter deficiência auditiva
```{r , echo = F}
#Sem o efeito do plano amostral 
...
#Foi pedido teste de sífilis para o parceiro
```{r , echo = F}
#Sem o efeito do plano amostral 
...
###Summary de teste de sífilis para o parceiro
```{r , echo = T}
#Considerando o banco todo
...
#Não resposta de teste de sífilis no parceirx
